...
that matters: any behaviour change must land in **all three scripts at once**, or CI will
catch the divergence. For security reports see [SECURITY.md](SECURITY.md).
